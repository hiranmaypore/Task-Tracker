...
try {
    ...
    Write-Host "  âœ“ Project created (ID: $projectId)" -ForegroundColor Green
} catch {
    Write-Host "  âœ— Project creation failed: $($_.Exception.Message)" -ForegroundColor Red
    exit 1
}
...
try {
    ...
    $taskId = $task.id
    Write-Host "  âœ“ Task created (ID: $taskId)" -ForegroundColor Green
    Write-Host "    Title: $($task.title)" -ForegroundColor Gray
} catch {
    Write-Host "  âœ— Task creation failed: $($_.Exception.Message)" -ForegroundColor Red
    exit 1
}
...
try {
    ...
    Write-Host "  âœ— WARNING: Task still exists!" -ForegroundColor Red
} catch {
    if ($_.Exception.Response.StatusCode -eq 404) {
        Write-Host "  âœ“ Task not found (correctly deleted)" -ForegroundColor Green
    } else {
...
try {
    ...
    Write-Host "  âœ“ Parent task created (ID: $parentTaskId)" -ForegroundColor Green
} catch {
    Write-Host "  âœ— Parent task creation failed: $($_.Exception.Message)" -ForegroundColor Red
    exit 1
}
...
try {
    ...
    Write-Host "  âœ“ Subtask created (ID: $subtaskId)" -ForegroundColor Green
    Write-Host "    Title: $($subtask.title)" -ForegroundColor Gray
    Write-Host "    Parent ID: $($subtask.parent_task_id)" -ForegroundColor Gray
} catch {
    Write-Host "  âœ— Subtask creation failed: $($_.Exception.Message)" -ForegroundColor Red
    exit 1
}
...
try {
    ...
    Write-Host "  âœ“ Subtask found" -ForegroundColor Green
} catch {
    Write-Host "  âœ— Subtask not found" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "  âœ“ Subtask deleted successfully!" -ForegroundColor Green
...
try {
    ...
    Write-Host "  âœ— WARNING: Subtask still exists!" -ForegroundColor Red
} catch {
    if ($_.Exception.Response.StatusCode -eq 404) {
        Write-Host "  âœ“ Subtask not found (correctly deleted)" -ForegroundColor Green
    } else {
        Write-Host "  âœ— Unexpected error: $($_.Exception.Message)" -ForegroundColor Red
    }
}
...
try {
    ...
    Write-Host "  âœ“ Parent task still exists (correct behavior)" -ForegroundColor Green
} catch {
    Write-Host "  âœ— Parent task was deleted (incorrect!)" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "  âœ“ Task created (ID: $commentTaskId)" -ForegroundColor Green
} catch {
    Write-Host "  âœ— Task creation failed: $($_.Exception.Message)" -ForegroundColor Red
    exit 1
}
...
try {
    ...
    Write-Host "  âœ“ Comment created (ID: $commentId)" -ForegroundColor Green
    Write-Host "    Content: $($comment.content)" -ForegroundColor Gray
} catch {
    Write-Host "  âœ— Comment creation failed: $($_.Exception.Message)" -ForegroundColor Red
    exit 1
}
...
try {
    ...
    Write-Host "  âœ“ Comment found" -ForegroundColor Green
} catch {
    Write-Host "  âœ— Comment not found" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "  âœ“ Comment deleted successfully!" -ForegroundColor Green
...
try {
    ...
    Write-Host "  âœ— WARNING: Comment still exists!" -ForegroundColor Red
} catch {
    if ($_.Exception.Response.StatusCode -eq 404) {
        Write-Host "  âœ“ Comment not found (correctly deleted)" -ForegroundColor Green
    } else {
        Write-Host "  âœ— Unexpected error: $($_.Exception.Message)" -ForegroundColor Red
    }
}
...
try {
    ...
    Write-Host "  âœ“ Task still exists (correct behavior)" -ForegroundColor Green
} catch {
    Write-Host "  âœ— Task was deleted (incorrect!)" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "  âœ“ Task created (ID: $multiCommentTaskId)" -ForegroundColor Green
} catch {
    Write-Host "  âœ— Task creation failed: $($_.Exception.Message)" -ForegroundColor Red
    exit 1
}
...
for ($i = 1; $i -le 3; $i++) {
    ...
    try {
        ...
        Write-Host "  âœ“ Comment #$i created (ID: $($multiComment.id))" -ForegroundColor Green
    } catch {
        Write-Host "  âœ— Comment #$i creation failed" -ForegroundColor Red
    }
}
...
foreach ($cId in $commentIds) {
    try {
        ...
        Write-Host "  âœ— Comment $cId still exists!" -ForegroundColor Red
        $allCommentsDeleted = $false
    } catch {
        if ($_.Exception.Response.StatusCode -eq 404) {
            Write-Host "  âœ“ Comment $cId deleted (cascade)" -ForegroundColor Green
        }
    }
}

if ($allCommentsDeleted) {
    Write-Host "`n  âœ“ All comments cascaded correctly!" -ForegroundColor Green
}
...
Write-Host "  âœ“ DELETE Subtask (via task endpoint)" -ForegroundColor Green
Write-Host "  âœ“ DELETE Comment" -ForegroundColor Green
Write-Host "  âœ“ CASCADE Delete (task with comments)" -ForegroundColor Green
Write-Host "`n========================================`n" -ForegroundColor Cyan
